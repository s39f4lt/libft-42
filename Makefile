...
#    Updated: 2018/12/20 16:31:35 by idunaver         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_isalnum.c ft_toupper.c ft_tolower.c ft_memalloc.c ft_memdel.c ft_strnew.c \
...
ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c ft_range.c ft_sqrt.c ft_swap.c \
ft_isprint.c ft_isascii.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c \
ft_lstiter.c ft_lstmap.c ft_isupper.c ft_islower.c ft_lstend.c
...
ft_isalnum.o ft_toupper.o ft_tolower.o ft_memalloc.o ft_memdel.o ft_strnew.o \
ft_strdel.o ft_strclr.o ft_striter.o ft_striteri.o ft_strmap.o ft_strmapi.o \
ft_strequ.o ft_strnequ.o ft_strsub.o ft_strjoin.o ft_strtrim.o ft_strsplit.o \
ft_itoa.o ft_putchar.o ft_putstr.o ft_putendl.o ft_putnbr.o ft_putchar_fd.o \
ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_range.o ft_sqrt.o ft_swap.o \
ft_isprint.o ft_isascii.o ft_lstnew.o ft_lstdelone.o ft_lstdel.o ft_lstadd.o \
ft_lstiter.o ft_lstmap.o ft_isupper.o ft_islower.o ft_lstend.o
